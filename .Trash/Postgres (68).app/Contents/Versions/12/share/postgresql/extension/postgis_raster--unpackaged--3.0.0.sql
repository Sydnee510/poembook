...
CREATE OR REPLACE FUNCTION postgis_raster_scripts_installed() RETURNS text
       AS $$ SELECT '3.0.0'::text || ' r' || 17983::text AS version $$
...
CREATE OR REPLACE FUNCTION _st_histogram(
	...
	RETURNS SETOF record
	AS '$libdir/postgis_raster-3','RASTER_histogramCoverage'
	LANGUAGE 'c' IMMUTABLE PARALLEL SAFE;
CREATE OR REPLACE FUNCTION st_histogram(
...
CREATE OR REPLACE FUNCTION _st_quantile(
	...
	RETURNS SETOF record
	AS '$libdir/postgis_raster-3','RASTER_quantileCoverage'
	LANGUAGE 'c' STABLE;
CREATE OR REPLACE FUNCTION st_quantile(
	rastertable text,
	rastercolumn text,
...
SELECT postgis_extension_drop_if_exists('postgis_raster', 'DROP TABLE _postgis_upgrade_info');
...
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
--
-- Generated on: 2020-01-24 11:52:08
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD VIEW raster_columns;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD AGGREGATE st_summarystatsagg (raster, integer, boolean, double precision);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD AGGREGATE st_summarystatsagg (raster, boolean, double precision);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD AGGREGATE st_summarystatsagg (raster, int, boolean);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD AGGREGATE st_countagg (raster, integer, boolean, double precision);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD AGGREGATE st_countagg (raster, integer, boolean);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD AGGREGATE st_countagg (raster, boolean);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD AGGREGATE st_samealignment (raster);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD AGGREGATE st_union (raster, unionarg[]);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD AGGREGATE st_union (raster, integer, text);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD AGGREGATE st_union (raster, integer);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD AGGREGATE st_union (raster);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD AGGREGATE st_union (raster, text);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD OPERATOR FAMILY hash_raster_ops USING hash;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD OPERATOR =  (raster,raster);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD OPERATOR ~  (raster,geometry);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD OPERATOR ~  (geometry,raster);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD CAST (raster AS box3d);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD CAST (raster AS geometry);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD CAST (raster AS bytea);
...
END;
$$ LANGUAGE 'plpgsql';
-- Register all functions except 2 needed for type definition.
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION postgis_raster_lib_version ();
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION postgis_raster_scripts_installed ();
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION postgis_raster_lib_build_date ();
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION postgis_gdal_version ();
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_envelope (raster);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_convexhull (raster);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_minconvexhull (
	rast raster,
	nband integer );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION box3d (raster);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_height (raster);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_numbands (raster);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_scalex (raster);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_scaley (raster);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_skewx (raster);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_skewy (raster);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_srid (raster);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_upperleftx (raster);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_upperlefty (raster);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_width (raster);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_pixelwidth (raster);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_pixelheight (raster);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_geotransform (raster,
    OUT imag double precision,
    OUT jmag double precision,
    OUT theta_i double precision,
    OUT theta_ij double precision,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_rotation (raster);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_metadata (
	rast raster,
	OUT upperleftx double precision,
	OUT upperlefty double precision,
	OUT width int,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_summary (rast raster);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION ST_MemSize (raster);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_makeemptyraster (width int, height int, upperleftx float8, upperlefty float8, scalex float8, scaley float8, skewx float8, skewy float8, srid int4 );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_makeemptyraster (width int, height int, upperleftx float8, upperlefty float8, pixelsize float8);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_makeemptyraster (rast raster);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_addband (rast raster, addbandargset addbandarg[]);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_addband (
	rast raster,
	index int,
	pixeltype text,
	initialvalue float8 ,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_band (rast raster, nbands int[] );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_band (rast raster, nband int);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_band (rast raster, nbands text, delimiter char );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_summarystats (
	rast raster,
	nband int ,
	exclude_nodata_value boolean ,
	sample_percent double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_summarystats (
	rast raster,
	nband int ,
	exclude_nodata_value boolean );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_approxsummarystats (
	rast raster,
	nband int ,
	exclude_nodata_value boolean ,
	sample_percent double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_summarystats_finalfn (internal);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_summarystats_transfn (
	internal,
	raster, integer,
	boolean, double precision
);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_count (rast raster, nband int , exclude_nodata_value boolean , sample_percent double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_count (rast raster, nband int , exclude_nodata_value boolean );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_count (rast raster, exclude_nodata_value boolean);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_approxcount (rast raster, nband int , exclude_nodata_value boolean , sample_percent double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_approxcount (rast raster, nband int, sample_percent double precision);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_approxcount (rast raster, exclude_nodata_value boolean, sample_percent double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_approxcount (rast raster, sample_percent double precision);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_countagg_finalfn (agg agg_count);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION __st_countagg_transfn (
	agg agg_count,
	rast raster,
 	nband integer , exclude_nodata_value boolean ,
	sample_percent double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_countagg_transfn (
	agg agg_count,
	rast raster,
 	nband integer, exclude_nodata_value boolean,
	sample_percent double precision
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_count (rastertable text, rastercolumn text, nband integer , exclude_nodata_value boolean , sample_percent double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_count (rastertable text, rastercolumn text, nband int , exclude_nodata_value boolean );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_count (rastertable text, rastercolumn text, exclude_nodata_value boolean);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_approxcount (rastertable text, rastercolumn text, nband int , exclude_nodata_value boolean , sample_percent double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_approxcount (rastertable text, rastercolumn text, nband int, sample_percent double precision);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_approxcount (rastertable text, rastercolumn text, exclude_nodata_value boolean, sample_percent double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_approxcount (rastertable text, rastercolumn text, sample_percent double precision);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_histogram (
	rast raster, nband int ,
	exclude_nodata_value boolean ,
	sample_percent double precision ,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_histogram (
	rast raster, nband int ,
	exclude_nodata_value boolean ,
	bins int , width double precision[] ,
	right boolean ,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_approxhistogram (
	rast raster, nband int ,
	exclude_nodata_value boolean ,
	sample_percent double precision ,
	bins int , width double precision[] ,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_quantile (
	rast raster,
	nband int ,
	exclude_nodata_value boolean ,
	sample_percent double precision ,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_quantile (
	rast raster,
	nband int ,
	exclude_nodata_value boolean ,
	quantiles double precision[] ,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_quantile (rast raster, nband int, exclude_nodata_value boolean, quantile double precision);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_quantile (rast raster, nband int, quantile double precision);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_quantile (rast raster, exclude_nodata_value boolean, quantile double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_quantile (rast raster, quantile double precision);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_approxquantile (
	rast raster,
	nband int ,
	exclude_nodata_value boolean ,
	sample_percent double precision ,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_approxquantile (rast raster, nband int, exclude_nodata_value boolean, sample_percent double precision, quantile double precision);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_approxquantile (rast raster, nband int, sample_percent double precision, quantile double precision);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_approxquantile (rast raster, sample_percent double precision, quantile double precision);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_approxquantile (rast raster, exclude_nodata_value boolean, quantile double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_approxquantile (rast raster, quantile double precision);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_quantile (rastertable text, rastercolumn text, nband int, exclude_nodata_value boolean, quantile double precision);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_quantile (rastertable text, rastercolumn text, nband int, quantile double precision);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_quantile (rastertable text, rastercolumn text, exclude_nodata_value boolean, quantile double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_quantile (rastertable text, rastercolumn text, quantile double precision);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_approxquantile (rastertable text, rastercolumn text, nband int, exclude_nodata_value boolean, sample_percent double precision, quantile double precision);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_approxquantile (rastertable text, rastercolumn text, nband int, sample_percent double precision, quantile double precision);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_approxquantile (rastertable text, rastercolumn text, sample_percent double precision, quantile double precision);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_approxquantile (rastertable text, rastercolumn text, exclude_nodata_value boolean, quantile double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_approxquantile (rastertable text, rastercolumn text, quantile double precision);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_valuecount (
	rast raster, nband integer ,
	exclude_nodata_value boolean ,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_valuecount (
	rast raster, nband integer ,
	exclude_nodata_value boolean ,
	searchvalues double precision[] ,
	roundto double precision ,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_valuecount (rast raster, nband integer, searchvalues double precision[], roundto double precision , OUT value double precision, OUT count integer);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_valuecount (rast raster, searchvalues double precision[], roundto double precision , OUT value double precision, OUT count integer);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_valuecount (rast raster, nband integer, exclude_nodata_value boolean, searchvalue double precision, roundto double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_valuecount (rast raster, nband integer, searchvalue double precision, roundto double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_valuecount (rast raster, searchvalue double precision, roundto double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_valuepercent (
	rast raster, nband integer ,
	exclude_nodata_value boolean ,
	searchvalues double precision[] ,
	roundto double precision ,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_valuepercent (rast raster, nband integer, searchvalues double precision[], roundto double precision , OUT value double precision, OUT percent double precision);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_valuepercent (rast raster, searchvalues double precision[], roundto double precision , OUT value double precision, OUT percent double precision);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_valuepercent (rast raster, nband integer, exclude_nodata_value boolean, searchvalue double precision, roundto double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_valuepercent (rast raster, nband integer, searchvalue double precision, roundto double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_valuepercent (rast raster, searchvalue double precision, roundto double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_valuecount (rastertable text, rastercolumn text, nband integer, searchvalues double precision[], roundto double precision , OUT value double precision, OUT count integer);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_valuecount (rastertable text, rastercolumn text, searchvalues double precision[], roundto double precision , OUT value double precision, OUT count integer);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_valuecount (rastertable text, rastercolumn text, nband integer, exclude_nodata_value boolean, searchvalue double precision, roundto double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_valuecount (rastertable text, rastercolumn text, nband integer, searchvalue double precision, roundto double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_valuecount (rastertable text, rastercolumn text, searchvalue double precision, roundto double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_valuepercent (rastertable text, rastercolumn text, nband integer, searchvalues double precision[], roundto double precision , OUT value double precision, OUT percent double precision);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_valuepercent (rastertable text, rastercolumn text, searchvalues double precision[], roundto double precision , OUT value double precision, OUT percent double precision);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_valuepercent (rastertable text, rastercolumn text, nband integer, exclude_nodata_value boolean, searchvalue double precision, roundto double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_valuepercent (rastertable text, rastercolumn text, nband integer, searchvalue double precision, roundto double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_valuepercent (rastertable text, rastercolumn text, searchvalue double precision, roundto double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_reclass (rast raster, VARIADIC reclassargset reclassarg[]);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_reclass (rast raster, VARIADIC reclassargset reclassarg[]);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_reclass (rast raster, nband int, reclassexpr text, pixeltype text, nodataval double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_reclass (rast raster, reclassexpr text, pixeltype text);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_colormap (
	rast raster, nband int,
	colormap text,
	method text );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_colormap (
	rast raster, nband int ,
	colormap text ,
	method text );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_fromgdalraster (gdaldata bytea, srid integer );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_gdaldrivers (
	OUT idx int,
	OUT short_name text,
	OUT long_name text,
	OUT can_read boolean,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_asgdalraster (rast raster, format text, options text[] , srid integer );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_astiff (rast raster, options text[] , srid integer );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_astiff (rast raster, nbands int[], options text[] , srid integer );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_astiff (rast raster, compression text, srid integer );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_astiff (rast raster, nbands int[], compression text, srid integer );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_asjpeg (rast raster, options text[] );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_asjpeg (rast raster, nbands int[], options text[] );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_asjpeg (rast raster, nbands int[], quality int);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_asjpeg (rast raster, nband int, options text[] );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_asjpeg (rast raster, nband int, quality int);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_aspng (rast raster, options text[] );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_aspng (rast raster, nbands int[], options text[] );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_aspng (rast raster, nbands int[], compression int);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_aspng (rast raster, nband int, options text[] );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_aspng (rast raster, nband int, compression int);
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_asraster (
	geom geometry,
	scalex double precision , scaley double precision ,
	width integer , height integer ,
	pixeltype text[] ,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_asraster (
	geom geometry,
	scalex double precision, scaley double precision,
	gridx double precision , gridy double precision ,
	pixeltype text[] ,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _ST_gdalwarp (
	rast raster,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_resample (
	rast raster,
	scalex double precision , scaley double precision ,
	gridx double precision , gridy double precision ,
	skewx double precision , skewy double precision ,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_transform (rast raster, srid integer, algorithm text , maxerr double precision , scalex double precision , scaley double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_transform (rast raster, srid integer, scalex double precision, scaley double precision, algorithm text , maxerr double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_transform (rast raster, srid integer, scalexy double precision, algorithm text , maxerr double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_transform (
	rast raster,
	alignto raster,
	algorithm text , maxerr double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_rescale (rast raster, scalex double precision, scaley double precision, algorithm text , maxerr double precision );
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_rescale (rast raster, scalexy double precision, algorithm text , maxerr double precision );
 RAISE NOTICE 'newly registered FUNCTION st_rescale (rast raster, scalexy double precision, algorithm text , maxerr double precision )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_rescale (rast raster, scalexy double precision, algorithm text , maxerr double precision )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_reskew (rast raster, skewx double precision, skewy double precision, algorithm text , maxerr double precision );
 RAISE NOTICE 'newly registered FUNCTION st_reskew (rast raster, skewx double precision, skewy double precision, algorithm text , maxerr double precision )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_reskew (rast raster, skewx double precision, skewy double precision, algorithm text , maxerr double precision )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_reskew (rast raster, skewxy double precision, algorithm text , maxerr double precision );
 RAISE NOTICE 'newly registered FUNCTION st_reskew (rast raster, skewxy double precision, algorithm text , maxerr double precision )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_reskew (rast raster, skewxy double precision, algorithm text , maxerr double precision )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_snaptogrid (
	rast raster,
	gridx double precision, gridy double precision,
	algorithm text , maxerr double precision ,
	scalex double precision , scaley double precision );
 RAISE NOTICE 'newly registered FUNCTION st_snaptogrid (
	rast raster,
	gridx double precision, gridy double precision,
	algorithm text , maxerr double precision ,
	scalex double precision , scaley double precision )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_snaptogrid (
	rast raster,
	gridx double precision, gridy double precision,
	algorithm text , maxerr double precision ,
	scalex double precision , scaley double precision )';
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_resize (
	rast raster,
	width text, height text,
	algorithm text , maxerr double precision );
 RAISE NOTICE 'newly registered FUNCTION st_resize (
	rast raster,
	width text, height text,
	algorithm text , maxerr double precision )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_resize (
	rast raster,
	width text, height text,
	algorithm text , maxerr double precision )';
  ELSE
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_mapalgebraexpr (rast raster, band integer, pixeltype text,
        expression text, nodataval double precision );
 RAISE NOTICE 'newly registered FUNCTION st_mapalgebraexpr (rast raster, band integer, pixeltype text,
        expression text, nodataval double precision )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_mapalgebraexpr (rast raster, band integer, pixeltype text,
        expression text, nodataval double precision )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_mapalgebraexpr (rast raster, pixeltype text, expression text,
        nodataval double precision );
 RAISE NOTICE 'newly registered FUNCTION st_mapalgebraexpr (rast raster, pixeltype text, expression text,
        nodataval double precision )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_mapalgebraexpr (rast raster, pixeltype text, expression text,
        nodataval double precision )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_mapalgebrafct (rast raster, band integer,
        pixeltype text, onerastuserfunc regprocedure, variadic args text[]);
 RAISE NOTICE 'newly registered FUNCTION st_mapalgebrafct (rast raster, band integer,
        pixeltype text, onerastuserfunc regprocedure, variadic args text[])';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_mapalgebrafct (rast raster, band integer,
        pixeltype text, onerastuserfunc regprocedure, variadic args text[])';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_mapalgebrafct (rast raster, pixeltype text,
        onerastuserfunc regprocedure, variadic args text[]);
 RAISE NOTICE 'newly registered FUNCTION st_mapalgebrafct (rast raster, pixeltype text,
        onerastuserfunc regprocedure, variadic args text[])';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_mapalgebrafct (rast raster, pixeltype text,
        onerastuserfunc regprocedure, variadic args text[])';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_mapalgebrafct (rast raster, onerastuserfunc regprocedure,
        variadic args text[]);
 RAISE NOTICE 'newly registered FUNCTION st_mapalgebrafct (rast raster, onerastuserfunc regprocedure,
        variadic args text[])';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_mapalgebrafct (rast raster, onerastuserfunc regprocedure,
        variadic args text[])';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_mapalgebraexpr (
	rast1 raster, band1 integer,
	rast2 raster, band2 integer,
	expression text,
 ...
 RAISE NOTICE 'newly registered FUNCTION st_mapalgebraexpr (
	rast1 raster, band1 integer,
	rast2 raster, band2 integer,
	expression text,
	pixeltype text , extenttype text ,
...
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_mapalgebraexpr (
	rast1 raster, band1 integer,
	rast2 raster, band2 integer,
	expression text,
	pixeltype text , extenttype text ,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_mapalgebrafct (
	rast1 raster, band1 integer,
	rast2 raster, band2 integer,
	tworastuserfunc regprocedure,
	pixeltype text , extenttype text ,
	VARIADIC userargs text[] );
 RAISE NOTICE 'newly registered FUNCTION st_mapalgebrafct (
	rast1 raster, band1 integer,
	rast2 raster, band2 integer,
	tworastuserfunc regprocedure,
	pixeltype text , extenttype text ,
...
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_mapalgebrafct (
	rast1 raster, band1 integer,
	rast2 raster, band2 integer,
	tworastuserfunc regprocedure,
	pixeltype text , extenttype text ,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_mapalgebrafctngb (
    rast raster,
    band integer,
    pixeltype text,
    ngbwidth integer,
 ...
 RAISE NOTICE 'newly registered FUNCTION st_mapalgebrafctngb (
    rast raster,
    band integer,
    pixeltype text,
    ngbwidth integer,
...
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_mapalgebrafctngb (
    rast raster,
    band integer,
    pixeltype text,
    ngbwidth integer,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_max4ma (matrix float[][], nodatamode text, variadic args text[]);
 RAISE NOTICE 'newly registered FUNCTION st_max4ma (matrix float[][], nodatamode text, variadic args text[])';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_max4ma (matrix float[][], nodatamode text, variadic args text[])';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_min4ma (matrix float[][], nodatamode text, variadic args text[]);
 RAISE NOTICE 'newly registered FUNCTION st_min4ma (matrix float[][], nodatamode text, variadic args text[])';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_min4ma (matrix float[][], nodatamode text, variadic args text[])';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_sum4ma (matrix float[][], nodatamode text, variadic args text[]);
 RAISE NOTICE 'newly registered FUNCTION st_sum4ma (matrix float[][], nodatamode text, variadic args text[])';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_sum4ma (matrix float[][], nodatamode text, variadic args text[])';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_mean4ma (matrix float[][], nodatamode text, variadic args text[]);
 RAISE NOTICE 'newly registered FUNCTION st_mean4ma (matrix float[][], nodatamode text, variadic args text[])';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_mean4ma (matrix float[][], nodatamode text, variadic args text[])';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_range4ma (matrix float[][], nodatamode text, variadic args text[]);
 RAISE NOTICE 'newly registered FUNCTION st_range4ma (matrix float[][], nodatamode text, variadic args text[])';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_range4ma (matrix float[][], nodatamode text, variadic args text[])';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_distinct4ma (matrix float[][], nodatamode TEXT, VARIADIC args TEXT[]);
 RAISE NOTICE 'newly registered FUNCTION st_distinct4ma (matrix float[][], nodatamode TEXT, VARIADIC args TEXT[])';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_distinct4ma (matrix float[][], nodatamode TEXT, VARIADIC args TEXT[])';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_stddev4ma (matrix float[][], nodatamode TEXT, VARIADIC args TEXT[]);
 RAISE NOTICE 'newly registered FUNCTION st_stddev4ma (matrix float[][], nodatamode TEXT, VARIADIC args TEXT[])';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_stddev4ma (matrix float[][], nodatamode TEXT, VARIADIC args TEXT[])';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_mapalgebra (
	rastbandargset rastbandarg[],
	callbackfunc regprocedure,
	pixeltype text ,
	distancex integer , distancey integer ,
	...
	mask double precision[][] , weighted boolean ,
	VARIADIC userargs text[] );
 RAISE NOTICE 'newly registered FUNCTION _st_mapalgebra (
	rastbandargset rastbandarg[],
	callbackfunc regprocedure,
	pixeltype text ,
	distancex integer , distancey integer ,
...
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_mapalgebra (
	rastbandargset rastbandarg[],
	callbackfunc regprocedure,
	pixeltype text ,
	distancex integer , distancey integer ,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_mapalgebra (
	rastbandargset rastbandarg[],
	callbackfunc regprocedure,
	pixeltype text ,
	extenttype text , customextent raster ,
	distancex integer , distancey integer ,
	VARIADIC userargs text[] );
 RAISE NOTICE 'newly registered FUNCTION st_mapalgebra (
	rastbandargset rastbandarg[],
	callbackfunc regprocedure,
	pixeltype text ,
	extenttype text , customextent raster ,
...
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_mapalgebra (
	rastbandargset rastbandarg[],
	callbackfunc regprocedure,
	pixeltype text ,
	extenttype text , customextent raster ,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_convertarray4ma (value double precision[][]);
 RAISE NOTICE 'newly registered FUNCTION _st_convertarray4ma (value double precision[][])';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_convertarray4ma (value double precision[][])';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_max4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] );
 RAISE NOTICE 'newly registered FUNCTION st_max4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_max4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_min4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] );
 RAISE NOTICE 'newly registered FUNCTION st_min4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_min4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_sum4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] );
 RAISE NOTICE 'newly registered FUNCTION st_sum4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_sum4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_mean4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] );
 RAISE NOTICE 'newly registered FUNCTION st_mean4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_mean4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_range4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] );
 RAISE NOTICE 'newly registered FUNCTION st_range4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_range4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_distinct4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] );
 RAISE NOTICE 'newly registered FUNCTION st_distinct4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_distinct4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_stddev4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] );
 RAISE NOTICE 'newly registered FUNCTION st_stddev4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_stddev4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_invdistweight4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] );
 RAISE NOTICE 'newly registered FUNCTION st_invdistweight4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_invdistweight4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_mindist4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] );
 RAISE NOTICE 'newly registered FUNCTION st_mindist4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_mindist4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_slope4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] );
 RAISE NOTICE 'newly registered FUNCTION _st_slope4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_slope4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_slope (
	rast raster, nband integer,
	customextent raster,
	pixeltype text , units text ,
	scale double precision ,	interpolate_nodata boolean );
 RAISE NOTICE 'newly registered FUNCTION st_slope (
	rast raster, nband integer,
	customextent raster,
	pixeltype text , units text ,
	scale double precision ,	interpolate_nodata boolean )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_slope (
	rast raster, nband integer,
	customextent raster,
	pixeltype text , units text ,
	scale double precision ,	interpolate_nodata boolean )';
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_aspect4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] );
 RAISE NOTICE 'newly registered FUNCTION _st_aspect4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_aspect4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_aspect (
	rast raster, nband integer,
	customextent raster,
	pixeltype text , units text ,
	interpolate_nodata boolean );
 RAISE NOTICE 'newly registered FUNCTION st_aspect (
	rast raster, nband integer,
	customextent raster,
	pixeltype text , units text ,
	interpolate_nodata boolean )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_aspect (
	rast raster, nband integer,
	customextent raster,
	pixeltype text , units text ,
	interpolate_nodata boolean )';
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_hillshade4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] );
 RAISE NOTICE 'newly registered FUNCTION _st_hillshade4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_hillshade4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_hillshade (
	rast raster, nband integer,
	customextent raster,
	pixeltype text ,
	...
	interpolate_nodata boolean );
 RAISE NOTICE 'newly registered FUNCTION st_hillshade (
	rast raster, nband integer,
	customextent raster,
	pixeltype text ,
	azimuth double precision , altitude double precision ,
...
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_hillshade (
	rast raster, nband integer,
	customextent raster,
	pixeltype text ,
	azimuth double precision , altitude double precision ,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_tpi4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] );
 RAISE NOTICE 'newly registered FUNCTION _st_tpi4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_tpi4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_tpi (
	rast raster, nband integer,
	customextent raster,
	pixeltype text , interpolate_nodata boolean );
 RAISE NOTICE 'newly registered FUNCTION st_tpi (
	rast raster, nband integer,
	customextent raster,
	pixeltype text , interpolate_nodata boolean )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_tpi (
	rast raster, nband integer,
	customextent raster,
	pixeltype text , interpolate_nodata boolean )';
  ELSE
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_roughness4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] );
 RAISE NOTICE 'newly registered FUNCTION _st_roughness4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_roughness4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_roughness (
	rast raster, nband integer,
	customextent raster,
	pixeltype text , interpolate_nodata boolean );
 RAISE NOTICE 'newly registered FUNCTION st_roughness (
	rast raster, nband integer,
	customextent raster,
	pixeltype text , interpolate_nodata boolean )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_roughness (
	rast raster, nband integer,
	customextent raster,
	pixeltype text , interpolate_nodata boolean )';
  ELSE
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_tri4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] );
 RAISE NOTICE 'newly registered FUNCTION _st_tri4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_tri4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_tri (
	rast raster, nband integer,
	customextent raster,
	pixeltype text ,	interpolate_nodata boolean );
 RAISE NOTICE 'newly registered FUNCTION st_tri (
	rast raster, nband integer,
	customextent raster,
	pixeltype text ,	interpolate_nodata boolean )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_tri (
	rast raster, nband integer,
	customextent raster,
	pixeltype text ,	interpolate_nodata boolean )';
  ELSE
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_grayscale4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] );
 RAISE NOTICE 'newly registered FUNCTION _st_grayscale4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_grayscale4ma (value double precision[][][], pos integer[][], VARIADIC userargs text[] )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_grayscale (
	rastbandargset rastbandarg[],
	extenttype text );
 RAISE NOTICE 'newly registered FUNCTION st_grayscale (
	rastbandargset rastbandarg[],
	extenttype text )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_grayscale (
	rastbandargset rastbandarg[],
	extenttype text )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_isempty (rast raster);
 RAISE NOTICE 'newly registered FUNCTION st_isempty (rast raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_isempty (rast raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_hasnoband (rast raster, nband int );
 RAISE NOTICE 'newly registered FUNCTION st_hasnoband (rast raster, nband int )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_hasnoband (rast raster, nband int )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_bandnodatavalue (rast raster, band integer );
 RAISE NOTICE 'newly registered FUNCTION st_bandnodatavalue (rast raster, band integer )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_bandnodatavalue (rast raster, band integer )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_bandisnodata (rast raster, band integer , forceChecking boolean );
 RAISE NOTICE 'newly registered FUNCTION st_bandisnodata (rast raster, band integer , forceChecking boolean )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_bandisnodata (rast raster, band integer , forceChecking boolean )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_bandisnodata (rast raster, forceChecking boolean);
 RAISE NOTICE 'newly registered FUNCTION st_bandisnodata (rast raster, forceChecking boolean)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_bandisnodata (rast raster, forceChecking boolean)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_bandpath (rast raster, band integer );
 RAISE NOTICE 'newly registered FUNCTION st_bandpath (rast raster, band integer )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_bandpath (rast raster, band integer )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION ST_BandPixelType (rast raster, band integer );
 RAISE NOTICE 'newly registered FUNCTION ST_BandPixelType (rast raster, band integer )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION ST_BandPixelType (rast raster, band integer )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION ST_BandMetaData (
	rast raster,
	band int[],
	OUT bandnum int,
	OUT pixeltype text,
 ...
 RAISE NOTICE 'newly registered FUNCTION ST_BandMetaData (
	rast raster,
	band int[],
	OUT bandnum int,
	OUT pixeltype text,
...
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION ST_BandMetaData (
	rast raster,
	band int[],
	OUT bandnum int,
	OUT pixeltype text,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION ST_BandFileSize (rast raster, band integer );
 RAISE NOTICE 'newly registered FUNCTION ST_BandFileSize (rast raster, band integer )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION ST_BandFileSize (rast raster, band integer )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION St_BandFileTimestamp (rast raster, band integer );
 RAISE NOTICE 'newly registered FUNCTION St_BandFileTimestamp (rast raster, band integer )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION St_BandFileTimestamp (rast raster, band integer )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_value (rast raster, band integer, x integer, y integer, exclude_nodata_value boolean );
 RAISE NOTICE 'newly registered FUNCTION st_value (rast raster, band integer, x integer, y integer, exclude_nodata_value boolean )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_value (rast raster, band integer, x integer, y integer, exclude_nodata_value boolean )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_value (rast raster, x integer, y integer, exclude_nodata_value boolean );
 RAISE NOTICE 'newly registered FUNCTION st_value (rast raster, x integer, y integer, exclude_nodata_value boolean )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_value (rast raster, x integer, y integer, exclude_nodata_value boolean )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_value (rast raster, band integer, pt geometry, exclude_nodata_value boolean );
 RAISE NOTICE 'newly registered FUNCTION st_value (rast raster, band integer, pt geometry, exclude_nodata_value boolean )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_value (rast raster, band integer, pt geometry, exclude_nodata_value boolean )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION ST_Value (rast raster, pt geometry, exclude_nodata_value boolean );
 RAISE NOTICE 'newly registered FUNCTION ST_Value (rast raster, pt geometry, exclude_nodata_value boolean )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION ST_Value (rast raster, pt geometry, exclude_nodata_value boolean )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_pixelofvalue (
	rast raster,
	nband integer,
	search double precision[],
	exclude_nodata_value boolean ,
 ...
 RAISE NOTICE 'newly registered FUNCTION st_pixelofvalue (
	rast raster,
	nband integer,
	search double precision[],
	exclude_nodata_value boolean ,
...
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_pixelofvalue (
	rast raster,
	nband integer,
	search double precision[],
	exclude_nodata_value boolean ,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_georeference (rast raster, format text );
 RAISE NOTICE 'newly registered FUNCTION st_georeference (rast raster, format text )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_georeference (rast raster, format text )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_setscale (rast raster, scale float8);
 RAISE NOTICE 'newly registered FUNCTION st_setscale (rast raster, scale float8)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_setscale (rast raster, scale float8)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_setscale (rast raster, scalex float8, scaley float8);
 RAISE NOTICE 'newly registered FUNCTION st_setscale (rast raster, scalex float8, scaley float8)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_setscale (rast raster, scalex float8, scaley float8)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_setskew (rast raster, skew float8);
 RAISE NOTICE 'newly registered FUNCTION st_setskew (rast raster, skew float8)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_setskew (rast raster, skew float8)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_setskew (rast raster, skewx float8, skewy float8);
 RAISE NOTICE 'newly registered FUNCTION st_setskew (rast raster, skewx float8, skewy float8)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_setskew (rast raster, skewx float8, skewy float8)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_setsrid (rast raster, srid integer);
 RAISE NOTICE 'newly registered FUNCTION st_setsrid (rast raster, srid integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_setsrid (rast raster, srid integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_setupperleft (rast raster, upperleftx float8, upperlefty float8);
 RAISE NOTICE 'newly registered FUNCTION st_setupperleft (rast raster, upperleftx float8, upperlefty float8)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_setupperleft (rast raster, upperleftx float8, upperlefty float8)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_setrotation (rast raster, rotation float8);
 RAISE NOTICE 'newly registered FUNCTION st_setrotation (rast raster, rotation float8)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_setrotation (rast raster, rotation float8)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_setgeotransform (rast raster,
    imag double precision,
    jmag double precision,
    theta_i double precision,
    theta_ij double precision,
    xoffset double precision,
    yoffset double precision);
 RAISE NOTICE 'newly registered FUNCTION st_setgeotransform (rast raster,
    imag double precision,
    jmag double precision,
    theta_i double precision,
    theta_ij double precision,
...
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_setgeotransform (rast raster,
    imag double precision,
    jmag double precision,
    theta_i double precision,
    theta_ij double precision,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_setgeoreference (rast raster, georef text, format text );
 RAISE NOTICE 'newly registered FUNCTION st_setgeoreference (rast raster, georef text, format text )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_setgeoreference (rast raster, georef text, format text )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_setgeoreference (
	rast raster,
	upperleftx double precision, upperlefty double precision,
	scalex double precision, scaley double precision,
	skewx double precision, skewy double precision
);
 RAISE NOTICE 'newly registered FUNCTION st_setgeoreference (
	rast raster,
	upperleftx double precision, upperlefty double precision,
	scalex double precision, scaley double precision,
	skewx double precision, skewy double precision
...
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_setgeoreference (
	rast raster,
	upperleftx double precision, upperlefty double precision,
	scalex double precision, scaley double precision,
	skewx double precision, skewy double precision
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_tile (
	rast raster,
	width integer, height integer,
	nband integer[] ,
	padwithnodata boolean , nodataval double precision );
 RAISE NOTICE 'newly registered FUNCTION _st_tile (
	rast raster,
	width integer, height integer,
	nband integer[] ,
	padwithnodata boolean , nodataval double precision )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_tile (
	rast raster,
	width integer, height integer,
	nband integer[] ,
	padwithnodata boolean , nodataval double precision )';
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_tile (
	rast raster, nband integer[],
	width integer, height integer,
	padwithnodata boolean , nodataval double precision );
 RAISE NOTICE 'newly registered FUNCTION st_tile (
	rast raster, nband integer[],
	width integer, height integer,
	padwithnodata boolean , nodataval double precision )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_tile (
	rast raster, nband integer[],
	width integer, height integer,
	padwithnodata boolean , nodataval double precision )';
  ELSE
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_setbandnodatavalue (rast raster, band integer, nodatavalue float8, forceChecking boolean );
 RAISE NOTICE 'newly registered FUNCTION st_setbandnodatavalue (rast raster, band integer, nodatavalue float8, forceChecking boolean )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_setbandnodatavalue (rast raster, band integer, nodatavalue float8, forceChecking boolean )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_setbandnodatavalue (rast raster, nodatavalue float8);
 RAISE NOTICE 'newly registered FUNCTION st_setbandnodatavalue (rast raster, nodatavalue float8)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_setbandnodatavalue (rast raster, nodatavalue float8)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_setbandisnodata (rast raster, band integer );
 RAISE NOTICE 'newly registered FUNCTION st_setbandisnodata (rast raster, band integer )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_setbandisnodata (rast raster, band integer )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_setbandpath (rast raster, band integer, outdbpath text, outdbindex integer, force boolean );
 RAISE NOTICE 'newly registered FUNCTION st_setbandpath (rast raster, band integer, outdbpath text, outdbindex integer, force boolean )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_setbandpath (rast raster, band integer, outdbpath text, outdbindex integer, force boolean )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_setbandindex (rast raster, band integer, outdbindex integer, force boolean );
 RAISE NOTICE 'newly registered FUNCTION st_setbandindex (rast raster, band integer, outdbindex integer, force boolean )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_setbandindex (rast raster, band integer, outdbindex integer, force boolean )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _ST_SetValues (
	rast raster, nband integer,
	x integer, y integer,
	newvalueset double precision[][],
	noset boolean[][] ,
	...
	nosetvalue double precision ,
	keepnodata boolean );
 RAISE NOTICE 'newly registered FUNCTION _ST_SetValues (
	rast raster, nband integer,
	x integer, y integer,
	newvalueset double precision[][],
	noset boolean[][] ,
...
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _ST_SetValues (
	rast raster, nband integer,
	x integer, y integer,
	newvalueset double precision[][],
	noset boolean[][] ,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION ST_SetValues (
	rast raster, nband integer,
	x integer, y integer,
	newvalueset double precision[][],
	noset boolean[][] ,
	keepnodata boolean );
 RAISE NOTICE 'newly registered FUNCTION ST_SetValues (
	rast raster, nband integer,
	x integer, y integer,
	newvalueset double precision[][],
	noset boolean[][] ,
...
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION ST_SetValues (
	rast raster, nband integer,
	x integer, y integer,
	newvalueset double precision[][],
	noset boolean[][] ,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION ST_SetValue (rast raster, band integer, x integer, y integer, newvalue float8);
 RAISE NOTICE 'newly registered FUNCTION ST_SetValue (rast raster, band integer, x integer, y integer, newvalue float8)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION ST_SetValue (rast raster, band integer, x integer, y integer, newvalue float8)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION ST_SetValue (rast raster, x integer, y integer, newvalue float8);
 RAISE NOTICE 'newly registered FUNCTION ST_SetValue (rast raster, x integer, y integer, newvalue float8)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION ST_SetValue (rast raster, x integer, y integer, newvalue float8)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION ST_SetValue (
	rast raster, nband integer,
	geom geometry, newvalue double precision
);
 RAISE NOTICE 'newly registered FUNCTION ST_SetValue (
	rast raster, nband integer,
	geom geometry, newvalue double precision
)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION ST_SetValue (
	rast raster, nband integer,
	geom geometry, newvalue double precision
)';
  ELSE
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_dumpaspolygons (rast raster, band integer , exclude_nodata_value boolean );
 RAISE NOTICE 'newly registered FUNCTION st_dumpaspolygons (rast raster, band integer , exclude_nodata_value boolean )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_dumpaspolygons (rast raster, band integer , exclude_nodata_value boolean )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_dumpvalues (
	rast raster, nband integer[] , exclude_nodata_value boolean ,
	OUT nband integer, OUT valarray double precision[][]
);
 RAISE NOTICE 'newly registered FUNCTION st_dumpvalues (
	rast raster, nband integer[] , exclude_nodata_value boolean ,
	OUT nband integer, OUT valarray double precision[][]
)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_dumpvalues (
	rast raster, nband integer[] , exclude_nodata_value boolean ,
	OUT nband integer, OUT valarray double precision[][]
)';
  ELSE
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_dumpvalues (rast raster, nband integer, exclude_nodata_value boolean );
 RAISE NOTICE 'newly registered FUNCTION st_dumpvalues (rast raster, nband integer, exclude_nodata_value boolean )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_dumpvalues (rast raster, nband integer, exclude_nodata_value boolean )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_polygon (rast raster, band integer );
 RAISE NOTICE 'newly registered FUNCTION st_polygon (rast raster, band integer )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_polygon (rast raster, band integer )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_pixelaspolygons (
	rast raster,
	band integer ,
	columnx integer ,
	rowy integer ,
 ...
 RAISE NOTICE 'newly registered FUNCTION _st_pixelaspolygons (
	rast raster,
	band integer ,
	columnx integer ,
	rowy integer ,
...
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_pixelaspolygons (
	rast raster,
	band integer ,
	columnx integer ,
	rowy integer ,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_pixelaspolygons (
	rast raster,
	band integer ,
	exclude_nodata_value boolean ,
	OUT geom geometry,
 ...
 RAISE NOTICE 'newly registered FUNCTION st_pixelaspolygons (
	rast raster,
	band integer ,
	exclude_nodata_value boolean ,
	OUT geom geometry,
...
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_pixelaspolygons (
	rast raster,
	band integer ,
	exclude_nodata_value boolean ,
	OUT geom geometry,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_pixelaspolygon (rast raster, x integer, y integer);
 RAISE NOTICE 'newly registered FUNCTION st_pixelaspolygon (rast raster, x integer, y integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_pixelaspolygon (rast raster, x integer, y integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_pixelaspoints (
	rast raster,
	band integer ,
	exclude_nodata_value boolean ,
	OUT geom geometry,
 ...
 RAISE NOTICE 'newly registered FUNCTION st_pixelaspoints (
	rast raster,
	band integer ,
	exclude_nodata_value boolean ,
	OUT geom geometry,
...
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_pixelaspoints (
	rast raster,
	band integer ,
	exclude_nodata_value boolean ,
	OUT geom geometry,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_pixelaspoint (rast raster, x integer, y integer);
 RAISE NOTICE 'newly registered FUNCTION st_pixelaspoint (rast raster, x integer, y integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_pixelaspoint (rast raster, x integer, y integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_pixelascentroids (
	rast raster,
	band integer ,
	exclude_nodata_value boolean ,
	OUT geom geometry,
 ...
 RAISE NOTICE 'newly registered FUNCTION st_pixelascentroids (
	rast raster,
	band integer ,
	exclude_nodata_value boolean ,
	OUT geom geometry,
...
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_pixelascentroids (
	rast raster,
	band integer ,
	exclude_nodata_value boolean ,
	OUT geom geometry,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_pixelascentroid (rast raster, x integer, y integer);
 RAISE NOTICE 'newly registered FUNCTION st_pixelascentroid (rast raster, x integer, y integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_pixelascentroid (rast raster, x integer, y integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_worldtorastercoord (
	rast raster,
	longitude double precision , latitude double precision ,
	OUT columnx integer,
	OUT rowy integer
);
 RAISE NOTICE 'newly registered FUNCTION _st_worldtorastercoord (
	rast raster,
	longitude double precision , latitude double precision ,
	OUT columnx integer,
	OUT rowy integer
...
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_worldtorastercoord (
	rast raster,
	longitude double precision , latitude double precision ,
	OUT columnx integer,
	OUT rowy integer
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_worldtorastercoord (
	rast raster,
	longitude double precision, latitude double precision,
	OUT columnx integer,
	OUT rowy integer
);
 RAISE NOTICE 'newly registered FUNCTION st_worldtorastercoord (
	rast raster,
	longitude double precision, latitude double precision,
	OUT columnx integer,
	OUT rowy integer
...
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_worldtorastercoord (
	rast raster,
	longitude double precision, latitude double precision,
	OUT columnx integer,
	OUT rowy integer
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_worldtorastercoordx (rast raster, xw float8, yw float8);
 RAISE NOTICE 'newly registered FUNCTION st_worldtorastercoordx (rast raster, xw float8, yw float8)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_worldtorastercoordx (rast raster, xw float8, yw float8)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_worldtorastercoordx (rast raster, xw float8);
 RAISE NOTICE 'newly registered FUNCTION st_worldtorastercoordx (rast raster, xw float8)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_worldtorastercoordx (rast raster, xw float8)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_worldtorastercoordx (rast raster, pt geometry);
 RAISE NOTICE 'newly registered FUNCTION st_worldtorastercoordx (rast raster, pt geometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_worldtorastercoordx (rast raster, pt geometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_worldtorastercoordy (rast raster, xw float8, yw float8);
 RAISE NOTICE 'newly registered FUNCTION st_worldtorastercoordy (rast raster, xw float8, yw float8)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_worldtorastercoordy (rast raster, xw float8, yw float8)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_worldtorastercoordy (rast raster, yw float8);
 RAISE NOTICE 'newly registered FUNCTION st_worldtorastercoordy (rast raster, yw float8)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_worldtorastercoordy (rast raster, yw float8)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_worldtorastercoordy (rast raster, pt geometry);
 RAISE NOTICE 'newly registered FUNCTION st_worldtorastercoordy (rast raster, pt geometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_worldtorastercoordy (rast raster, pt geometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_rastertoworldcoord (
	rast raster,
	columnx integer , rowy integer ,
	OUT longitude double precision,
	OUT latitude double precision
);
 RAISE NOTICE 'newly registered FUNCTION _st_rastertoworldcoord (
	rast raster,
	columnx integer , rowy integer ,
	OUT longitude double precision,
	OUT latitude double precision
...
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_rastertoworldcoord (
	rast raster,
	columnx integer , rowy integer ,
	OUT longitude double precision,
	OUT latitude double precision
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_rastertoworldcoord (
	rast raster,
	columnx integer, rowy integer,
	OUT longitude double precision,
	OUT latitude double precision
);
 RAISE NOTICE 'newly registered FUNCTION st_rastertoworldcoord (
	rast raster,
	columnx integer, rowy integer,
	OUT longitude double precision,
	OUT latitude double precision
...
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_rastertoworldcoord (
	rast raster,
	columnx integer, rowy integer,
	OUT longitude double precision,
	OUT latitude double precision
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_rastertoworldcoordx (rast raster, xr int, yr int);
 RAISE NOTICE 'newly registered FUNCTION st_rastertoworldcoordx (rast raster, xr int, yr int)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_rastertoworldcoordx (rast raster, xr int, yr int)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_rastertoworldcoordx (rast raster, xr int);
 RAISE NOTICE 'newly registered FUNCTION st_rastertoworldcoordx (rast raster, xr int)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_rastertoworldcoordx (rast raster, xr int)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_rastertoworldcoordy (rast raster, xr int, yr int);
 RAISE NOTICE 'newly registered FUNCTION st_rastertoworldcoordy (rast raster, xr int, yr int)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_rastertoworldcoordy (rast raster, xr int, yr int)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_rastertoworldcoordy (rast raster, yr int);
 RAISE NOTICE 'newly registered FUNCTION st_rastertoworldcoordy (rast raster, yr int)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_rastertoworldcoordy (rast raster, yr int)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_minpossiblevalue (pixeltype text);
 RAISE NOTICE 'newly registered FUNCTION st_minpossiblevalue (pixeltype text)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_minpossiblevalue (pixeltype text)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_rastfromwkb (bytea);
 RAISE NOTICE 'newly registered FUNCTION st_rastfromwkb (bytea)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_rastfromwkb (bytea)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_rastfromhexwkb (text);
 RAISE NOTICE 'newly registered FUNCTION st_rastfromhexwkb (text)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_rastfromhexwkb (text)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_aswkb (raster, outasin boolean );
 RAISE NOTICE 'newly registered FUNCTION st_aswkb (raster, outasin boolean )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_aswkb (raster, outasin boolean )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_asbinary (raster, outasin boolean );
 RAISE NOTICE 'newly registered FUNCTION st_asbinary (raster, outasin boolean )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_asbinary (raster, outasin boolean )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_ashexwkb (raster, outasin boolean );
 RAISE NOTICE 'newly registered FUNCTION st_ashexwkb (raster, outasin boolean )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_ashexwkb (raster, outasin boolean )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION bytea (raster);
 RAISE NOTICE 'newly registered FUNCTION bytea (raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION bytea (raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION raster_hash (raster);
 RAISE NOTICE 'newly registered FUNCTION raster_hash (raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION raster_hash (raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION raster_eq (raster, raster);
 RAISE NOTICE 'newly registered FUNCTION raster_eq (raster, raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION raster_eq (raster, raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION raster_overleft (raster, raster);
 RAISE NOTICE 'newly registered FUNCTION raster_overleft (raster, raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION raster_overleft (raster, raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION raster_overright (raster, raster);
 RAISE NOTICE 'newly registered FUNCTION raster_overright (raster, raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION raster_overright (raster, raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION raster_left (raster, raster);
 RAISE NOTICE 'newly registered FUNCTION raster_left (raster, raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION raster_left (raster, raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION raster_right (raster, raster);
 RAISE NOTICE 'newly registered FUNCTION raster_right (raster, raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION raster_right (raster, raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION raster_overabove (raster, raster);
 RAISE NOTICE 'newly registered FUNCTION raster_overabove (raster, raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION raster_overabove (raster, raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION raster_overbelow (raster, raster);
 RAISE NOTICE 'newly registered FUNCTION raster_overbelow (raster, raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION raster_overbelow (raster, raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION raster_above (raster, raster);
 RAISE NOTICE 'newly registered FUNCTION raster_above (raster, raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION raster_above (raster, raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION raster_below (raster, raster);
 RAISE NOTICE 'newly registered FUNCTION raster_below (raster, raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION raster_below (raster, raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION raster_same (raster, raster);
 RAISE NOTICE 'newly registered FUNCTION raster_same (raster, raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION raster_same (raster, raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION raster_contained (raster, raster);
 RAISE NOTICE 'newly registered FUNCTION raster_contained (raster, raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION raster_contained (raster, raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION raster_contain (raster, raster);
 RAISE NOTICE 'newly registered FUNCTION raster_contain (raster, raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION raster_contain (raster, raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION raster_overlap (raster, raster);
 RAISE NOTICE 'newly registered FUNCTION raster_overlap (raster, raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION raster_overlap (raster, raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION raster_geometry_contain (raster, geometry);
 RAISE NOTICE 'newly registered FUNCTION raster_geometry_contain (raster, geometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION raster_geometry_contain (raster, geometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION raster_contained_by_geometry (raster, geometry);
 RAISE NOTICE 'newly registered FUNCTION raster_contained_by_geometry (raster, geometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION raster_contained_by_geometry (raster, geometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION raster_geometry_overlap (raster, geometry);
 RAISE NOTICE 'newly registered FUNCTION raster_geometry_overlap (raster, geometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION raster_geometry_overlap (raster, geometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION geometry_raster_contain (geometry, raster);
 RAISE NOTICE 'newly registered FUNCTION geometry_raster_contain (geometry, raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION geometry_raster_contain (geometry, raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION geometry_contained_by_raster (geometry, raster);
 RAISE NOTICE 'newly registered FUNCTION geometry_contained_by_raster (geometry, raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION geometry_contained_by_raster (geometry, raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION geometry_raster_overlap (geometry, raster);
 RAISE NOTICE 'newly registered FUNCTION geometry_raster_overlap (geometry, raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION geometry_raster_overlap (geometry, raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_samealignment (rast1 raster, rast2 raster);
 RAISE NOTICE 'newly registered FUNCTION st_samealignment (rast1 raster, rast2 raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_samealignment (rast1 raster, rast2 raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_samealignment (
	ulx1 double precision, uly1 double precision, scalex1 double precision, scaley1 double precision, skewx1 double precision, skewy1 double precision,
	ulx2 double precision, uly2 double precision, scalex2 double precision, scaley2 double precision, skewx2 double precision, skewy2 double precision
);
 RAISE NOTICE 'newly registered FUNCTION st_samealignment (
	ulx1 double precision, uly1 double precision, scalex1 double precision, scaley1 double precision, skewx1 double precision, skewy1 double precision,
	ulx2 double precision, uly2 double precision, scalex2 double precision, scaley2 double precision, skewx2 double precision, skewy2 double precision
)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_samealignment (
	ulx1 double precision, uly1 double precision, scalex1 double precision, scaley1 double precision, skewx1 double precision, skewy1 double precision,
	ulx2 double precision, uly2 double precision, scalex2 double precision, scaley2 double precision, skewx2 double precision, skewy2 double precision
)';
  ELSE
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_samealignment_transfn (agg agg_samealignment, rast raster);
 RAISE NOTICE 'newly registered FUNCTION _st_samealignment_transfn (agg agg_samealignment, rast raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_samealignment_transfn (agg agg_samealignment, rast raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _ST_samealignment_finalfn (agg agg_samealignment);
 RAISE NOTICE 'newly registered FUNCTION _ST_samealignment_finalfn (agg agg_samealignment)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _ST_samealignment_finalfn (agg agg_samealignment)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_notsamealignmentreason (rast1 raster, rast2 raster);
 RAISE NOTICE 'newly registered FUNCTION st_notsamealignmentreason (rast1 raster, rast2 raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_notsamealignmentreason (rast1 raster, rast2 raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_iscoveragetile (rast raster, coverage raster, tilewidth integer, tileheight integer);
 RAISE NOTICE 'newly registered FUNCTION st_iscoveragetile (rast raster, coverage raster, tilewidth integer, tileheight integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_iscoveragetile (rast raster, coverage raster, tilewidth integer, tileheight integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_intersects (rast1 raster, nband1 integer, rast2 raster, nband2 integer);
 RAISE NOTICE 'newly registered FUNCTION _st_intersects (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_intersects (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_intersects (rast1 raster, nband1 integer, rast2 raster, nband2 integer);
 RAISE NOTICE 'newly registered FUNCTION st_intersects (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_intersects (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_intersects (rast1 raster, rast2 raster);
 RAISE NOTICE 'newly registered FUNCTION st_intersects (rast1 raster, rast2 raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_intersects (rast1 raster, rast2 raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_intersects (geom geometry, rast raster, nband integer );
 RAISE NOTICE 'newly registered FUNCTION _st_intersects (geom geometry, rast raster, nband integer )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_intersects (geom geometry, rast raster, nband integer )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_intersects (geom geometry, rast raster, nband integer );
 RAISE NOTICE 'newly registered FUNCTION st_intersects (geom geometry, rast raster, nband integer )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_intersects (geom geometry, rast raster, nband integer )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_intersects (rast raster, geom geometry, nband integer );
 RAISE NOTICE 'newly registered FUNCTION st_intersects (rast raster, geom geometry, nband integer )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_intersects (rast raster, geom geometry, nband integer )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_intersects (rast raster, nband integer, geom geometry);
 RAISE NOTICE 'newly registered FUNCTION st_intersects (rast raster, nband integer, geom geometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_intersects (rast raster, nband integer, geom geometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_overlaps (rast1 raster, nband1 integer, rast2 raster, nband2 integer);
 RAISE NOTICE 'newly registered FUNCTION _st_overlaps (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_overlaps (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_overlaps (rast1 raster, nband1 integer, rast2 raster, nband2 integer);
 RAISE NOTICE 'newly registered FUNCTION st_overlaps (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_overlaps (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_overlaps (rast1 raster, rast2 raster);
 RAISE NOTICE 'newly registered FUNCTION st_overlaps (rast1 raster, rast2 raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_overlaps (rast1 raster, rast2 raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_touches (rast1 raster, nband1 integer, rast2 raster, nband2 integer);
 RAISE NOTICE 'newly registered FUNCTION _st_touches (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_touches (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_touches (rast1 raster, nband1 integer, rast2 raster, nband2 integer);
 RAISE NOTICE 'newly registered FUNCTION st_touches (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_touches (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_touches (rast1 raster, rast2 raster);
 RAISE NOTICE 'newly registered FUNCTION st_touches (rast1 raster, rast2 raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_touches (rast1 raster, rast2 raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_contains (rast1 raster, nband1 integer, rast2 raster, nband2 integer);
 RAISE NOTICE 'newly registered FUNCTION _st_contains (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_contains (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_contains (rast1 raster, nband1 integer, rast2 raster, nband2 integer);
 RAISE NOTICE 'newly registered FUNCTION st_contains (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_contains (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_contains (rast1 raster, rast2 raster);
 RAISE NOTICE 'newly registered FUNCTION st_contains (rast1 raster, rast2 raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_contains (rast1 raster, rast2 raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_containsproperly (rast1 raster, nband1 integer, rast2 raster, nband2 integer);
 RAISE NOTICE 'newly registered FUNCTION _st_containsproperly (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_containsproperly (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_containsproperly (rast1 raster, nband1 integer, rast2 raster, nband2 integer);
 RAISE NOTICE 'newly registered FUNCTION st_containsproperly (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_containsproperly (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_containsproperly (rast1 raster, rast2 raster);
 RAISE NOTICE 'newly registered FUNCTION st_containsproperly (rast1 raster, rast2 raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_containsproperly (rast1 raster, rast2 raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_covers (rast1 raster, nband1 integer, rast2 raster, nband2 integer);
 RAISE NOTICE 'newly registered FUNCTION _st_covers (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_covers (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_covers (rast1 raster, nband1 integer, rast2 raster, nband2 integer);
 RAISE NOTICE 'newly registered FUNCTION st_covers (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_covers (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_covers (rast1 raster, rast2 raster);
 RAISE NOTICE 'newly registered FUNCTION st_covers (rast1 raster, rast2 raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_covers (rast1 raster, rast2 raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_coveredby (rast1 raster, nband1 integer, rast2 raster, nband2 integer);
 RAISE NOTICE 'newly registered FUNCTION _st_coveredby (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_coveredby (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_coveredby (rast1 raster, nband1 integer, rast2 raster, nband2 integer);
 RAISE NOTICE 'newly registered FUNCTION st_coveredby (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_coveredby (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_coveredby (rast1 raster, rast2 raster);
 RAISE NOTICE 'newly registered FUNCTION st_coveredby (rast1 raster, rast2 raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_coveredby (rast1 raster, rast2 raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_within (rast1 raster, nband1 integer, rast2 raster, nband2 integer);
 RAISE NOTICE 'newly registered FUNCTION _st_within (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_within (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_within (rast1 raster, nband1 integer, rast2 raster, nband2 integer);
 RAISE NOTICE 'newly registered FUNCTION st_within (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_within (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_within (rast1 raster, rast2 raster);
 RAISE NOTICE 'newly registered FUNCTION st_within (rast1 raster, rast2 raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_within (rast1 raster, rast2 raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _ST_DWithin (rast1 raster, nband1 integer, rast2 raster, nband2 integer, distance double precision);
 RAISE NOTICE 'newly registered FUNCTION _ST_DWithin (rast1 raster, nband1 integer, rast2 raster, nband2 integer, distance double precision)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _ST_DWithin (rast1 raster, nband1 integer, rast2 raster, nband2 integer, distance double precision)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION ST_DWithin (rast1 raster, nband1 integer, rast2 raster, nband2 integer, distance double precision);
 RAISE NOTICE 'newly registered FUNCTION ST_DWithin (rast1 raster, nband1 integer, rast2 raster, nband2 integer, distance double precision)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION ST_DWithin (rast1 raster, nband1 integer, rast2 raster, nband2 integer, distance double precision)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION ST_DWithin (rast1 raster, rast2 raster, distance double precision);
 RAISE NOTICE 'newly registered FUNCTION ST_DWithin (rast1 raster, rast2 raster, distance double precision)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION ST_DWithin (rast1 raster, rast2 raster, distance double precision)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _ST_DFullyWithin (rast1 raster, nband1 integer, rast2 raster, nband2 integer, distance double precision);
 RAISE NOTICE 'newly registered FUNCTION _ST_DFullyWithin (rast1 raster, nband1 integer, rast2 raster, nband2 integer, distance double precision)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _ST_DFullyWithin (rast1 raster, nband1 integer, rast2 raster, nband2 integer, distance double precision)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION ST_DFullyWithin (rast1 raster, nband1 integer, rast2 raster, nband2 integer, distance double precision);
 RAISE NOTICE 'newly registered FUNCTION ST_DFullyWithin (rast1 raster, nband1 integer, rast2 raster, nband2 integer, distance double precision)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION ST_DFullyWithin (rast1 raster, nband1 integer, rast2 raster, nband2 integer, distance double precision)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION ST_DFullyWithin (rast1 raster, rast2 raster, distance double precision);
 RAISE NOTICE 'newly registered FUNCTION ST_DFullyWithin (rast1 raster, rast2 raster, distance double precision)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION ST_DFullyWithin (rast1 raster, rast2 raster, distance double precision)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_disjoint (rast1 raster, nband1 integer, rast2 raster, nband2 integer);
 RAISE NOTICE 'newly registered FUNCTION st_disjoint (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_disjoint (rast1 raster, nband1 integer, rast2 raster, nband2 integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION ST_Disjoint (rast1 raster, rast2 raster);
 RAISE NOTICE 'newly registered FUNCTION ST_Disjoint (rast1 raster, rast2 raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION ST_Disjoint (rast1 raster, rast2 raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION ST_Intersection (geomin geometry, rast raster, band integer );
 RAISE NOTICE 'newly registered FUNCTION ST_Intersection (geomin geometry, rast raster, band integer )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION ST_Intersection (geomin geometry, rast raster, band integer )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_intersection (rast raster, band integer, geomin geometry);
 RAISE NOTICE 'newly registered FUNCTION st_intersection (rast raster, band integer, geomin geometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_intersection (rast raster, band integer, geomin geometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION ST_Intersection (rast raster, geomin geometry);
 RAISE NOTICE 'newly registered FUNCTION ST_Intersection (rast raster, geomin geometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION ST_Intersection (rast raster, geomin geometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION ST_Intersection (
	rast1 raster, band1 int,
	rast2 raster, band2 int,
	returnband text ,
	nodataval double precision[] );
 RAISE NOTICE 'newly registered FUNCTION ST_Intersection (
	rast1 raster, band1 int,
	rast2 raster, band2 int,
	returnband text ,
	nodataval double precision[] )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION ST_Intersection (
	rast1 raster, band1 int,
	rast2 raster, band2 int,
	returnband text ,
	nodataval double precision[] )';
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_union_finalfn (internal);
 RAISE NOTICE 'newly registered FUNCTION _st_union_finalfn (internal)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_union_finalfn (internal)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_union_transfn (internal, raster, unionarg[]);
 RAISE NOTICE 'newly registered FUNCTION _st_union_transfn (internal, raster, unionarg[])';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_union_transfn (internal, raster, unionarg[])';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_union_transfn (internal, raster, integer, text);
 RAISE NOTICE 'newly registered FUNCTION _st_union_transfn (internal, raster, integer, text)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_union_transfn (internal, raster, integer, text)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_union_transfn (internal, raster, integer);
 RAISE NOTICE 'newly registered FUNCTION _st_union_transfn (internal, raster, integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_union_transfn (internal, raster, integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_union_transfn (internal, raster);
 RAISE NOTICE 'newly registered FUNCTION _st_union_transfn (internal, raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_union_transfn (internal, raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_union_transfn (internal, raster, text);
 RAISE NOTICE 'newly registered FUNCTION _st_union_transfn (internal, raster, text)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_union_transfn (internal, raster, text)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_clip (
	rast raster, nband integer[],
	geom geometry,
	nodataval double precision[] , crop boolean );
 RAISE NOTICE 'newly registered FUNCTION _st_clip (
	rast raster, nband integer[],
	geom geometry,
	nodataval double precision[] , crop boolean )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_clip (
	rast raster, nband integer[],
	geom geometry,
	nodataval double precision[] , crop boolean )';
  ELSE
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_clip (
	rast raster, nband integer[],
	geom geometry,
	nodataval double precision[] , crop boolean );
 RAISE NOTICE 'newly registered FUNCTION st_clip (
	rast raster, nband integer[],
	geom geometry,
	nodataval double precision[] , crop boolean )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_clip (
	rast raster, nband integer[],
	geom geometry,
	nodataval double precision[] , crop boolean )';
  ELSE
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_nearestvalue (
	rast raster, band integer,
	pt geometry,
	exclude_nodata_value boolean );
 RAISE NOTICE 'newly registered FUNCTION st_nearestvalue (
	rast raster, band integer,
	pt geometry,
	exclude_nodata_value boolean )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_nearestvalue (
	rast raster, band integer,
	pt geometry,
	exclude_nodata_value boolean )';
  ELSE
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_neighborhood (
	rast raster, band integer,
	columnx integer, rowy integer,
	distancex integer, distancey integer,
	exclude_nodata_value boolean );
 RAISE NOTICE 'newly registered FUNCTION _st_neighborhood (
	rast raster, band integer,
	columnx integer, rowy integer,
	distancex integer, distancey integer,
	exclude_nodata_value boolean )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_neighborhood (
	rast raster, band integer,
	columnx integer, rowy integer,
	distancex integer, distancey integer,
	exclude_nodata_value boolean )';
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_neighborhood (
	rast raster, band integer,
	columnx integer, rowy integer,
	distancex integer, distancey integer,
	exclude_nodata_value boolean );
 RAISE NOTICE 'newly registered FUNCTION st_neighborhood (
	rast raster, band integer,
	columnx integer, rowy integer,
	distancex integer, distancey integer,
	exclude_nodata_value boolean )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_neighborhood (
	rast raster, band integer,
	columnx integer, rowy integer,
	distancex integer, distancey integer,
	exclude_nodata_value boolean )';
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _add_raster_constraint (cn name, sql text);
 RAISE NOTICE 'newly registered FUNCTION _add_raster_constraint (cn name, sql text)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _add_raster_constraint (cn name, sql text)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _drop_raster_constraint (rastschema name, rasttable name, cn name);
 RAISE NOTICE 'newly registered FUNCTION _drop_raster_constraint (rastschema name, rasttable name, cn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _drop_raster_constraint (rastschema name, rasttable name, cn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _raster_constraint_info_srid (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _raster_constraint_info_srid (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _raster_constraint_info_srid (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _add_raster_constraint_srid (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _add_raster_constraint_srid (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _add_raster_constraint_srid (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _drop_raster_constraint_srid (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _drop_raster_constraint_srid (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _drop_raster_constraint_srid (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _raster_constraint_info_scale (rastschema name, rasttable name, rastcolumn name, axis char);
 RAISE NOTICE 'newly registered FUNCTION _raster_constraint_info_scale (rastschema name, rasttable name, rastcolumn name, axis char)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _raster_constraint_info_scale (rastschema name, rasttable name, rastcolumn name, axis char)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _add_raster_constraint_scale (rastschema name, rasttable name, rastcolumn name, axis char);
 RAISE NOTICE 'newly registered FUNCTION _add_raster_constraint_scale (rastschema name, rasttable name, rastcolumn name, axis char)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _add_raster_constraint_scale (rastschema name, rasttable name, rastcolumn name, axis char)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _drop_raster_constraint_scale (rastschema name, rasttable name, rastcolumn name, axis char);
 RAISE NOTICE 'newly registered FUNCTION _drop_raster_constraint_scale (rastschema name, rasttable name, rastcolumn name, axis char)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _drop_raster_constraint_scale (rastschema name, rasttable name, rastcolumn name, axis char)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _raster_constraint_info_blocksize (rastschema name, rasttable name, rastcolumn name, axis text);
 RAISE NOTICE 'newly registered FUNCTION _raster_constraint_info_blocksize (rastschema name, rasttable name, rastcolumn name, axis text)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _raster_constraint_info_blocksize (rastschema name, rasttable name, rastcolumn name, axis text)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _add_raster_constraint_blocksize (rastschema name, rasttable name, rastcolumn name, axis text);
 RAISE NOTICE 'newly registered FUNCTION _add_raster_constraint_blocksize (rastschema name, rasttable name, rastcolumn name, axis text)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _add_raster_constraint_blocksize (rastschema name, rasttable name, rastcolumn name, axis text)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _drop_raster_constraint_blocksize (rastschema name, rasttable name, rastcolumn name, axis text);
 RAISE NOTICE 'newly registered FUNCTION _drop_raster_constraint_blocksize (rastschema name, rasttable name, rastcolumn name, axis text)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _drop_raster_constraint_blocksize (rastschema name, rasttable name, rastcolumn name, axis text)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _raster_constraint_info_extent (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _raster_constraint_info_extent (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _raster_constraint_info_extent (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _add_raster_constraint_extent (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _add_raster_constraint_extent (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _add_raster_constraint_extent (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _drop_raster_constraint_extent (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _drop_raster_constraint_extent (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _drop_raster_constraint_extent (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _raster_constraint_info_alignment (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _raster_constraint_info_alignment (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _raster_constraint_info_alignment (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _add_raster_constraint_alignment (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _add_raster_constraint_alignment (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _add_raster_constraint_alignment (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _drop_raster_constraint_alignment (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _drop_raster_constraint_alignment (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _drop_raster_constraint_alignment (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _raster_constraint_info_spatially_unique (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _raster_constraint_info_spatially_unique (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _raster_constraint_info_spatially_unique (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _add_raster_constraint_spatially_unique (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _add_raster_constraint_spatially_unique (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _add_raster_constraint_spatially_unique (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _drop_raster_constraint_spatially_unique (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _drop_raster_constraint_spatially_unique (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _drop_raster_constraint_spatially_unique (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _raster_constraint_info_coverage_tile (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _raster_constraint_info_coverage_tile (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _raster_constraint_info_coverage_tile (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _add_raster_constraint_coverage_tile (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _add_raster_constraint_coverage_tile (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _add_raster_constraint_coverage_tile (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _drop_raster_constraint_coverage_tile (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _drop_raster_constraint_coverage_tile (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _drop_raster_constraint_coverage_tile (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _raster_constraint_info_regular_blocking (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _raster_constraint_info_regular_blocking (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _raster_constraint_info_regular_blocking (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _drop_raster_constraint_regular_blocking (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _drop_raster_constraint_regular_blocking (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _drop_raster_constraint_regular_blocking (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _raster_constraint_info_num_bands (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _raster_constraint_info_num_bands (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _raster_constraint_info_num_bands (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _add_raster_constraint_num_bands (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _add_raster_constraint_num_bands (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _add_raster_constraint_num_bands (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _drop_raster_constraint_num_bands (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _drop_raster_constraint_num_bands (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _drop_raster_constraint_num_bands (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _raster_constraint_info_pixel_types (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _raster_constraint_info_pixel_types (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _raster_constraint_info_pixel_types (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _raster_constraint_pixel_types (rast raster);
 RAISE NOTICE 'newly registered FUNCTION _raster_constraint_pixel_types (rast raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _raster_constraint_pixel_types (rast raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _add_raster_constraint_pixel_types (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _add_raster_constraint_pixel_types (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _add_raster_constraint_pixel_types (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _drop_raster_constraint_pixel_types (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _drop_raster_constraint_pixel_types (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _drop_raster_constraint_pixel_types (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _raster_constraint_info_nodata_values (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _raster_constraint_info_nodata_values (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _raster_constraint_info_nodata_values (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _raster_constraint_nodata_values (rast raster);
 RAISE NOTICE 'newly registered FUNCTION _raster_constraint_nodata_values (rast raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _raster_constraint_nodata_values (rast raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _add_raster_constraint_nodata_values (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _add_raster_constraint_nodata_values (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _add_raster_constraint_nodata_values (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _drop_raster_constraint_nodata_values (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _drop_raster_constraint_nodata_values (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _drop_raster_constraint_nodata_values (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _raster_constraint_info_out_db (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _raster_constraint_info_out_db (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _raster_constraint_info_out_db (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _raster_constraint_out_db (rast raster);
 RAISE NOTICE 'newly registered FUNCTION _raster_constraint_out_db (rast raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _raster_constraint_out_db (rast raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _add_raster_constraint_out_db (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _add_raster_constraint_out_db (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _add_raster_constraint_out_db (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _drop_raster_constraint_out_db (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _drop_raster_constraint_out_db (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _drop_raster_constraint_out_db (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _raster_constraint_info_index (rastschema name, rasttable name, rastcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _raster_constraint_info_index (rastschema name, rasttable name, rastcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _raster_constraint_info_index (rastschema name, rasttable name, rastcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION AddRasterConstraints  (
	rastschema name,
	rasttable name,
	rastcolumn name,
	VARIADIC constraints text[]
);
 RAISE NOTICE 'newly registered FUNCTION AddRasterConstraints  (
	rastschema name,
	rasttable name,
	rastcolumn name,
	VARIADIC constraints text[]
...
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION AddRasterConstraints  (
	rastschema name,
	rasttable name,
	rastcolumn name,
	VARIADIC constraints text[]
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION DropRasterConstraints  (
	rastschema name,
	rasttable name,
	rastcolumn name,
	VARIADIC constraints text[]
);
 RAISE NOTICE 'newly registered FUNCTION DropRasterConstraints  (
	rastschema name,
	rasttable name,
	rastcolumn name,
	VARIADIC constraints text[]
...
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION DropRasterConstraints  (
	rastschema name,
	rasttable name,
	rastcolumn name,
	VARIADIC constraints text[]
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _overview_constraint (ov raster, factor integer, refschema name, reftable name, refcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _overview_constraint (ov raster, factor integer, refschema name, reftable name, refcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _overview_constraint (ov raster, factor integer, refschema name, reftable name, refcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _overview_constraint_info (
	ovschema name, ovtable name, ovcolumn name,
	OUT refschema name, OUT reftable name, OUT refcolumn name, OUT factor integer
);
 RAISE NOTICE 'newly registered FUNCTION _overview_constraint_info (
	ovschema name, ovtable name, ovcolumn name,
	OUT refschema name, OUT reftable name, OUT refcolumn name, OUT factor integer
)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _overview_constraint_info (
	ovschema name, ovtable name, ovcolumn name,
	OUT refschema name, OUT reftable name, OUT refcolumn name, OUT factor integer
)';
  ELSE
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _add_overview_constraint (
	ovschema name, ovtable name, ovcolumn name,
	refschema name, reftable name, refcolumn name,
	factor integer
);
 RAISE NOTICE 'newly registered FUNCTION _add_overview_constraint (
	ovschema name, ovtable name, ovcolumn name,
	refschema name, reftable name, refcolumn name,
	factor integer
)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _add_overview_constraint (
	ovschema name, ovtable name, ovcolumn name,
	refschema name, reftable name, refcolumn name,
	factor integer
)';
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _drop_overview_constraint (ovschema name, ovtable name, ovcolumn name);
 RAISE NOTICE 'newly registered FUNCTION _drop_overview_constraint (ovschema name, ovtable name, ovcolumn name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _drop_overview_constraint (ovschema name, ovtable name, ovcolumn name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION AddOverviewConstraints  (
	ovschema name, ovtable name, ovcolumn name,
	refschema name, reftable name, refcolumn name,
	ovfactor int
);
 RAISE NOTICE 'newly registered FUNCTION AddOverviewConstraints  (
	ovschema name, ovtable name, ovcolumn name,
	refschema name, reftable name, refcolumn name,
	ovfactor int
)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION AddOverviewConstraints  (
	ovschema name, ovtable name, ovcolumn name,
	refschema name, reftable name, refcolumn name,
	ovfactor int
)';
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION DropOverviewConstraints  (
	ovschema name,
	ovtable name,
	ovcolumn name
);
 RAISE NOTICE 'newly registered FUNCTION DropOverviewConstraints  (
	ovschema name,
	ovtable name,
	ovcolumn name
)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION DropOverviewConstraints  (
	ovschema name,
	ovtable name,
	ovcolumn name
)';
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _UpdateRasterSRID (
	schema_name name, table_name name, column_name name,
	new_srid integer
);
 RAISE NOTICE 'newly registered FUNCTION _UpdateRasterSRID (
	schema_name name, table_name name, column_name name,
	new_srid integer
)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _UpdateRasterSRID (
	schema_name name, table_name name, column_name name,
	new_srid integer
)';
  ELSE
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION UpdateRasterSRID (
	schema_name name, table_name name, column_name name,
	new_srid integer
);
 RAISE NOTICE 'newly registered FUNCTION UpdateRasterSRID (
	schema_name name, table_name name, column_name name,
	new_srid integer
)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION UpdateRasterSRID (
	schema_name name, table_name name, column_name name,
	new_srid integer
)';
  ELSE
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION ST_Retile (tab regclass, col name, ext geometry, sfx float8, sfy float8, tw int, th int, algo text );
 RAISE NOTICE 'newly registered FUNCTION ST_Retile (tab regclass, col name, ext geometry, sfx float8, sfy float8, tw int, th int, algo text )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION ST_Retile (tab regclass, col name, ext geometry, sfx float8, sfy float8, tw int, th int, algo text )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION ST_CreateOverview (tab regclass, col name, factor int, algo text );
 RAISE NOTICE 'newly registered FUNCTION ST_CreateOverview (tab regclass, col name, factor int, algo text )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION ST_CreateOverview (tab regclass, col name, factor int, algo text )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_makeemptycoverage (tilewidth int, tileheight int, width int, height int, upperleftx float8, upperlefty float8, scalex float8, scaley float8, skewx float8, skewy float8, srid int4 );
 RAISE NOTICE 'newly registered FUNCTION st_makeemptycoverage (tilewidth int, tileheight int, width int, height int, upperleftx float8, upperlefty float8, scalex float8, scaley float8, skewx float8, skewy float8, srid int4 )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_makeemptycoverage (tilewidth int, tileheight int, width int, height int, upperleftx float8, upperlefty float8, scalex float8, scaley float8, skewx float8, skewy float8, srid int4 )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION postgis_noop (raster);
 RAISE NOTICE 'newly registered FUNCTION postgis_noop (raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION postgis_noop (raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION raster_in (cstring);
 RAISE NOTICE 'newly registered FUNCTION raster_in (cstring)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION raster_in (cstring)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION raster_out (raster);
 RAISE NOTICE 'newly registered FUNCTION raster_out (raster)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION raster_out (raster)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD TYPE raster;
 RAISE NOTICE 'newly registered TYPE raster';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered TYPE raster';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD TYPE rastbandarg;
 RAISE NOTICE 'newly registered TYPE rastbandarg';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered TYPE rastbandarg';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD TYPE geomval;
 RAISE NOTICE 'newly registered TYPE geomval';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered TYPE geomval';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD TYPE addbandarg;
 RAISE NOTICE 'newly registered TYPE addbandarg';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered TYPE addbandarg';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD TYPE summarystats;
 RAISE NOTICE 'newly registered TYPE summarystats';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered TYPE summarystats';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD TYPE agg_count;
 RAISE NOTICE 'newly registered TYPE agg_count';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered TYPE agg_count';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD TYPE reclassarg;
 RAISE NOTICE 'newly registered TYPE reclassarg';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered TYPE reclassarg';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD TYPE agg_samealignment;
 RAISE NOTICE 'newly registered TYPE agg_samealignment';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered TYPE agg_samealignment';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD TYPE unionarg;
 RAISE NOTICE 'newly registered TYPE unionarg';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered TYPE unionarg';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
